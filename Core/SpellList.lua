...
addon.OffensiveBuffList = {
    ...
    [1249658] = { name = "Breath of Sindragosa", class = "DEATHKNIGHT", tier = "major", castWindow = 8 },
    ...
    [391528] = { name = "Convoke the Spirits", class = "DRUID", tier = "major", castWindow = 4 },

    [375087] = { name = "Dragonrage", class = "EVOKER", tier = "major" },
    [403631] = { name = "Breath of Eons", class = "EVOKER", tier = "major", castWindow = 10 },

    [19574] = { name = "Bestial Wrath", class = "HUNTER", tier = "major" },
    [288613] = { name = "Trueshot", class = "HUNTER", tier = "major" },
    [359844] = { name = "Call of the Wild", class = "HUNTER", tier = "major", castWindow = 20 },
    [1253860] = { name = "Takedown", class = "HUNTER", tier = "major", castSpellID = 1250646, castWindow = 8 },
    ...
    [208141] = { name = "Ray of Frost", class = "MAGE", tier = "major", castWindow = 4 },

    [1249625] = { name = "Zenith", class = "MONK", tier = "major" },
    [443028] = { name = "Celestial Conduit", class = "MONK", tier = "major", castSpellID = 1248992, castWindow = 4 },
    [123904] = { name = "Invoke Xuen, the White Tiger", class = "MONK", tier = "major", castWindow = 20 },
    ...
    [228260] = { name = "Voidform", class = "PRIEST", tier = "major", castWindow = 20 },
    [391109] = { name = "Dark Ascension", class = "PRIEST", tier = "major" },
    [453094] = { name = "Halo", class = "PRIEST", tier = "major", castWindow = 4 },

    [13750] = { name = "Adrenaline Rush", class = "ROGUE", tier = "major", castWindow = 20 },
    [121471] = { name = "Shadow Blades", class = "ROGUE", tier = "major", castWindow = 20 },
    [185422] = { name = "Shadow Dance", class = "ROGUE", tier = "major", castSpellID = 185313, castWindow = 8 },
    [212283] = { name = "Symbols of Death", class = "ROGUE", tier = "major", castWindow = 10 },
    [360194] = { name = "Deathmark", class = "ROGUE", tier = "major", castWindow = 16 },
    [385627] = { name = "Kingsbane", class = "ROGUE", tier = "major", castWindow = 14 },
    [384631] = { name = "Flagellation", class = "ROGUE", tier = "major", castWindow = 12 },
    [51690] = { name = "Killing Spree", class = "ROGUE", tier = "major", castWindow = 6 },
    [280719] = { name = "Secret Technique", class = "ROGUE", tier = "major", castWindow = 6 },
    [426591] = { name = "Goremaw's Bite", class = "ROGUE", tier = "major", castWindow = 6 },
    ...
    [444995] = { name = "Surging Totem", class = "SHAMAN", tier = "major", castWindow = 25 },

    [265273] = { name = "Summon Demonic Tyrant", class = "WARLOCK", tier = "major", castWindow = 15 },
    [1122] = { name = "Summon Infernal", class = "WARLOCK", tier = "major", castWindow = 30 },
    [205180] = { name = "Summon Darkglare", class = "WARLOCK", tier = "major", castWindow = 20 },
